      ...
      <div className="flex gap-y-10 gap-x-12 w-full shadow-md p-4 rounded-lg">
        <div className="grid grid-cols-3 gap-10 p-4 w-full">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-base font-semibold">{data?.team}</h1>
          </div>
          <div className="flex flex-col">
        ...
        <div className="grid grid-cols-3 gap-10 p-4 w-full">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-base font-semibold">{data?.priority}</h1>
          </div>
          <div className="flex flex-col">
            <h1 className="text-muted-foreground text-sm">Status:</h1>
            <h1 className="text-base font-semibold">{data?.status}</h1>
          </div>
          <div className="flex flex-col col-span-2 row-span-2 ">
            <h1 className="text-muted-foreground text-sm">Remarks:</h1>
            <h1 className="text-base font-semibold">{data?.remarks}</h1>
          </div>
          <div className="flex flex-col">
