      ...
      <div className="flex flex-col w-full max-w-[90%] mx-auto p-6 bg-white shadow-lg rounded-lg">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex justify-start items-center gap-4">
            {data?.body.dateReceived != null &&
              data?.body.requestee?.id === currentUserId &&
              data?.body.status !== "RESOLVED" &&
              previousPath === `/dashboard/tickets/inbox/${currentUserId}` && (
                <ConfirmationModal
            ...
            {data?.body.dateReceived != null &&
              data?.body.receiver?.id === currentUserId &&
              data?.body.status !== "RESOLVED" &&
              previousPath === `/dashboard/tickets/inbox/${currentUserId}` && <ForwardTicketBtn id={id} />}
          </div>
        </div>
