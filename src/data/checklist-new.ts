...
export const checkList = [
  ...
  },
  {
    ...
    application: [
      ...
      {
        name: "Area Clearance-Mines and Geosciences Bureau (MGB)",
        value: "Area Clearance-Mines and Geosciences Bureau (MGB)",
        category: "AC-MGB",
        checkList: ["Accomplished Application Form", "Letter of Request", "Site Development Plan/Vicinity Map"],
      },
      {
        name: "Area Clearance-Mines and Geosciences Bureau (PRA)",
        value: "Area Clearance-Mines and Geosciences Bureau (PRA)",
        category: "AC-PRA",
        checkList: ["Accomplished Application Form", "Letter of Request", "Site Development Plan/Vicinity Map"],
      },
      
      {
        ...
        checkList: [
          ...
          "Cadmium and Cadmium Compounds Management Plan",
          "Emergency and Contingency Plan",
          "Photo of Storage facility",
          "Notarized Certificate of Liabilities to compensate damages",
          "Copy of PCO Accreditation Certificate",
          "Latest Self-Monitoring Report",
          "Management Operation Flow Chart (Manufacturing)",
          "Chemical Management Plan",
          "Valid contract with registered TSD Facility",
        ],
      },
      {
        name: "CHROMIUM (VI) COMPOUNDS",
        value: " CHROMIUM (VI) COMPOUNDS",
        category: "CCO",
        checkList: [
          "Photocopy of the Environmental permits such as the following:",
          "Photocopy of Registration with the Securities and Exchange Commission (SEC) or Department of Trade and Industry (DTI), with an updated list of its officers",
          "Photocopy of Business Permit",
          "Photocopy of Safety Data Sheet (SDS) from the manufacturing firm",
      ...
      },
      {
        ...
        checkList: [
          ...
          " Either SEC registration, DTI registration, CDA registration whichever is applicable together with the list of its officers",
          "Safety Data Sheet (SDS) from the manufacturing firm every time in an importer applies for registration of a new chemical",
          "Documents describing applicant’s handling procedure, safety precautions and emergency response for the chemical",
        ],
      },
      {
        ...
        checkList: [
          ...
          "Environmental Compliance Cert. (ECC)",
          "Permit to Operate APSE (POA) and/or Wastewater Discharge Permit (WDP)",
          " TSD Permit",
          "Cert. of liabilities of parties to compensate for damage to properties and in life in case of emergencies and accidents;",
      ...
      },
      {
        ...
        category: "CCO",
        checkList: [
          "  Any person or entity who imports and manufactures asbestos and asbestos-containing products in the Philippines must register with the Bureau",
          "Any person or entity who imports asbestos and asbestos-containing products must get an importation clearance from the Bureau",
          "Any person or entity involved in the treatment, storage, demolition, transport and disposal of asbestos and friable asbestos containing wastes must register with the Bureau",
          "Existing industrial, commercial and institutional structures with sprayed on asbestos and friable asbestos containing materials shall register with the Bureau.",
        ],
      },
      {
        name: "MERCURY AND MERCURY COMPOUNDS",
        value: "MERCURY AND MERCURY COMPOUNDS",
        category: "CCO",
        checkList: [
          "Duly accomplished and notarized registration form",
          " Duly accomplished importation clearance form",
          "Hazardous Waste Generator’s ID",
      ...
      {
        name: "CYANIDE AND CYANIDE COMPOUNDS",
        value: "CYANIDE AND CYANIDE COMPOUNDS",
        category: "CCO",
        checkList: [
          "Duly accomplished and notarized registration form",
          "Duly accomplished importation clearance form",
          ...
          "Valid Permit to Operate",
          "Environmental Compliance Certificate (ECC)",
          "Photocopy of registration with the Securities and Exchange Commission (SEC) or Department of Trade and Industry (DTI), with an updated list of its officersPhotocopy of Business Permit",
          "Photocopy of the Safety data Sheet (SDS) from the manufacturing firm",
      ...
      },
      {
        ...
        value: "LEAD AND LEAD COMPOUNDS",
        category: "CCO",
        checkList: [
          "Duly accomplished and notarized registration form",
          "Covering Letter",
          "CCO Chemical Management Plan",
          "DENR ID Number",
          "Environmental Compliance Certificate/ Certificate of Non-coverage",
          "Valid Discharge Permit/Interconnection Certificate",
          "Valid Permit to Operate/Exemptio",
          " SEC Registration",
          "Business Permit",
          "Certification of Liabilities of parties to compensate for damage to properties and life in case of emergencies and accident",
          "Photo documentation of storage facilities and others",
          "PCO accreditation certificate and relevant training certificate/s",
          "Quarterly Self-Monitoring Report incorporating the Certificate of Analysis of wastewater samples",
        ],
      },
      {
        name: "ARSENIC",
      ...
      },
      {
        ...
        category: "ECC",
        checkList: ["Letter of Request for change of company/proponent name", "Amended SEC Registration or DTI Registration"],
      },
      {
      ...
      },
      {
        ...
        category: "ECC",
        checkList: ["Letter of Request to rectify the typographical error"],
      },
      {
        ...
        value:
          "ECC Amendment (Minor) - Extension of deadlines for submission of post-ECC Requirements (i.e., submission of MMT, MOA, Carbon Sink Program)",
        category: "ECC",
        checkList: [
          "Letter of Request for extension of deadlines of submission of ECC requirements",
          "Supporting documents on the request to extend the deadline for submission of post ECC requirements",
        ],
      },
      {
      ...
      },
      {
        ...
        checkList: [
          ...
          "Copy of Hazardous Waste Generator ID",
          "Copy of Effluent Test Results",
          "Proof of SMR Submissions",
          "Module 1 and 3 of SMR",
          "Plumbing and Drainage Layout",
          "Proof of Compliance to Permit Condition",
          "Sketch Plan (Signed and Sealed)",
          "Wastewater Treatment Facility Plan and Elevation (Signed and Sealed)",
          "Engineer’s Report",
          "Other Documents (which may be required by EMB)",
      ...
      },
      {
        ...
        category: "HWID",
        checkList: [
          "Letter for additional Hazardous Waste",
      ...
      },
      {
        ...
        category: "PTT",
        checkList: [
          "Accomplished online PTT application form",
      ...
      },
      {
        ...
        category: "CMR",
        checkList: [
          "Copy Government and Company ID of the Proponent and Authorized Representative or Pollution Control Officer",
